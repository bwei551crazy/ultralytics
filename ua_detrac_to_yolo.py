...
#obtained from the repo: https://github.com/wy17646051/UA-DETRAC-Format-Converter/tree/main
#Code is from the repo's process.py
#works only within the ua-detrac dataset folder
...
def parse_opt():
    ...
    parser.add_argument('--lbl_train', type=str, default='./DETRAC-Train-Annotations-XML/DETRAC-Train-Annotations-XML', help='train labels path')
    parser.add_argument('--lbl_val', type=str, default='./DETRAC-Test-Annotations-XML/DETRAC-Test-Annotations-XML', help='validation labels path')
